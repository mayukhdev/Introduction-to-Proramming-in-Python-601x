...
class NewsStory(object):
    def __init__(self, gui, tle, sub, summ, lk):
        self.guid  = gui
        self.title = tle
        self.subject = sub
        self.summary = summ
...
def main_thread(master):
    ...
    try:
        ...
        triggerlist = readTriggerConfig("C:\Users\Mayukh\prog_python\Week 7\ProblemSet7\\triggers.txt")
